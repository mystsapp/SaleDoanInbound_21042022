...
namespace Data.Models_Tourlewi
{
    public partial class Vetour
    {
        ...
        public int Hoahongct { get; set; }
        public int Hoahongnv { get; set; }
        public decimal Tienhoahong { get; set; }
        public DateTime? Ngaychihh { get; set; }
        public string Nguoinhanhh { get; set; }
        public string Cmndnguoinhanhh { get; set; }
        public string Mstnguoinhanhh { get; set; }
        ...
        public string Diachinguoinhanhh { get; set; }
